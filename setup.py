...
PACKAGENAME = metadata.get('package_name', 'testref')
DESCRIPTION = metadata.get('description', 'testref')
AUTHOR = metadata.get('author', 'Matthew Hill')
AUTHOR_EMAIL = metadata.get('author_email', '')
LICENSE = metadata.get('license', 'unknown')
URL = metadata.get('url', 'https://bitbucket.org/stsci-mesa/reference-file-testing-tool/')
